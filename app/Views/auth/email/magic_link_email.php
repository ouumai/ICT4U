                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 30px rgba(79, 70, 229, 0.08);">
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px;">
                            ...
                            <p style="margin: 0 0 15px; color: #1e293b; font-size: 16px;">Hai <b><?= esc($user->username) ?></b>,</p>
                            ...
                            <div style="text-align: center; margin-bottom: 30px;">
                                ...
                                style="background-color: #4f46e5; color: #ffffff; padding: 15px 35px; border-radius: 12px; text-decoration: none; font-weight: 700; display: inline-block;">Log Masuk Sekarang</a>
                            </div>
                            <p style="margin: 0; color: #ff3131; font-size: 13px; font-weight: 700; text-align: center;">Pautan ini sah untuk 5 minit sahaja.</p>
                        </td>
                    </tr>
