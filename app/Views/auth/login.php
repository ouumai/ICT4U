...
<head>
    ...
    <style>
        ...
        .image-section {
            flex: 1;
            /* Pastikan path gambar ni betul dalam folder public/assets/image/ */
        ...
        <form action="<?= url_to('login') ?>" method="post">
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <a href="<?= url_to('magic-link') ?>"class="small text-decoration-none fw-bold" style="color: var(--brand-color);">Lupa Kata Laluan?</a>
                </div>
            ...
            <p class="text-center small text-secondary fw-semibold">
                Belum mempunyai akaun? <a href="<?= url_to('register') ?>" class="fw-bold text-decoration-none hover:underline" style="color: var(--brand-color);">Daftar Sekarang</a>
            </p>
        </form>
